...
import { cloudStore } from "@/api/cloud"
...
//   const [pageNum] = useAtom(pageNumberAtom)
  ...
  useEffect(() => {
    ...
    const fetchPDF = async () => {
      try {
        const response = await cloudStore.get(`${props.id}/${props.num}`)
  ...
  return (
    <div
      id="pdfCont"
      ref={pdfContRef}
      className="h-[700px] bg-gray-100 dark:bg-gray-900"
    >
      <div className="pdfContainer rounded-lg">
        ...
        <div className="absolute -mt-5 flex justify-center rounded-xl bg-white p-1.5 shadow-md dark:bg-gray-800 z-30">
